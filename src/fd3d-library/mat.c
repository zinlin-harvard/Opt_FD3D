 ...
 */
#undef __FUNCT__
#define __FUNCT__ "create_A_and_b"
PetscErrorCode create_A_and_b(Mat *A, Vec *b, Vec *right_precond, Mat *CF, Vec *conjParam, Vec *conjSrc, GridInfo gi, TimeStamp *ts, Vec eps, Vec mu, Vec srcJ, Vec srcM)
{
	PetscFunctionBegin;
	PetscErrorCode ierr;
