...
PetscErrorCode create_A_and_b(Mat *A, Vec *b, Vec *right_precond, Mat *HE, Vec *conjParam, Vec *conjSrc, GridInfo gi, TimeStamp *ts, Vec eps, Vec mu, Vec srcJ, Vec srcM);
